...
* `start_link/3` - стартира процеса и връща `{:ok, pid}`. Приема като аргументи името на модул, имплементиращ GenServer, първи аргумент на `init` функцията и списък с настройки.
