...
* Какво беше link?
  * Какво става с един процес, когато някой негов линкнат терминира?
...
* Удобно когато искаме да използваме pipe operator-а към анонимна
функция
...
* `Agent` е абстракция вкарана от Elixir над процеси.
