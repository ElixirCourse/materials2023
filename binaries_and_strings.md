...
* Как да си правим наши си "типове"?
* Какво е протокол?
* Четирите слоя на езика са?
...
* Когато структурата ни е по-голяма от *64* **байта** се пази в обща памет за всички процеси на даден `node`.
