...
* Позволявайки ни да манипулираме AST-то чрез макроси.
...
- Добре, `quote` ни дава вътрешната репрезентация на някой израз.
...
* Дава ни да оценим даден израз(AST) спрямо даден контекст.
...
- Какво става ако имаме израз от типа: `[1, 2, 6]` и искаме да вмъкнем
`[3, 4, 5]`
