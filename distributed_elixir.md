...
* Това е OTP модул, който вътрешно `Node` ползва за да направи node дистрибутиран.
* Като цяло дърво от процеси, които знаят как да комуникират с отдалечени нодове и техните процеси.
...
* Дългите са за мрежа и могат да съдържат достъпно локално или далечно IP или domain name
...
* Процесът group_leader им е group_leader-ът на процесът, който ги е spawn-ал.
